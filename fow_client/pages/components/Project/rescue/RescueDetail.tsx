  ...
  const submit = async (e: any) => {
    ...
    try {
      if(typeof window !== 'undefined') {
        ...
        const bigNumberValue = new BigNumber(transaction, 16)
        console.log(bigNumberValue)
  
        alert("Successfully send the request😀")
        setDisabled(false)
        updateMessage('')
        window.location.replace("/components/Project/rescue/PaymentComplete")
      }
    ...
    <div className="flex flex-col justify-center items-center bg-inherit">
      ...
      <div className={styles.page}>
        <div className={styles.head}>
          ...
          <Link href="/components/Project/rescue/MyRescues">
